...
public class RedisSessionRepository {
    ...
    public static class SessionData {
        ...
        public DeviceSession toDeviceSession() {
            IMEI imeiObj = imei != null ? IMEI.of(imei) : null;

            // Use full constructor with all necessary fields, providing nulls to use
            ...
            DeviceSession session = new DeviceSession(
                    ...
                    channelId,
                    remoteAddress,
                    null, // protocolVersion (defaults in DeviceSession)
                    null, // deviceVariant (defaults in DeviceSession)
                    null, // status (defaults in DeviceSession)
                    authenticated,
                    createdAt,
                    lastActivityAt,
                    lastActivityAt, // lastLoginAt (best guess to use lastActivityAt)
